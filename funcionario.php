    ...
    <body>																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																		                                                                                                                                                                                         																																																																														                                                                               																																																																										  
        <div id="container">
            ...
            <div id="copy" style="height: 75px; position: absolute; bottom: 0px; left:0px; border: none; width: 100%;"><br/><br/><br/>
                <div style="height:30px; text-align:center; padding-top:15px; background:#CCC; background: linear-gradient(top , rgb(234, 234, 234) , rgb(203, 203, 203) 100%);
                            ...
                            <input class="button_send" type="submit" value="Sair">
                                ...
                                <div id="menu">
                                    <ul id="navigation" >
                                        ...
                                        <li style="background: url(images/azulclaro3.jpg) no-repeat; background-position: 0px 12px;"><a class="m1" href="javascript:showPage('examesMarcados.php', '');" title="aller � la section 3"><br />EXAMES AGENDADOS</a></li>
