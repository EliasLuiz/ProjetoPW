...
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Pessoa` (
  ...
  `dtInsercaoPessoa` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `mydb`.`TB_Consulta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Consulta` (
  ...
  INDEX `fk_TB_Consulta_TB_Cliente_has_TB_Medico1_idx` (`cdCliente` ASC, `cdMedico` ASC),
  CONSTRAINT `fk_TB_Consulta_TB_Cliente_has_TB_Medico1`
    FOREIGN KEY (`cdCliente` , `cdMedico`)
    REFERENCES `mydb`.`TB_Cliente_has_TB_Medico` (`cdCliente` , `cdMedico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`TB_Medico_temp`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Medico_temp` (
  `cdMedico_temp` INT NOT NULL AUTO_INCREMENT,
  `crm` VARCHAR(11) NOT NULL,
  `nmMedico` VARCHAR(100) NOT NULL,
  `status` TINYINT(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`cdMedico_temp`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Exame` (
  ...
  INDEX `fk_TB_Cliente_has_TB_Exame_TB_Consulta1_idx` (`cdConsulta` ASC),
  INDEX `fk_TB_Exame_TB_Convenio1_idx` (`cdConvenio` ASC),
  INDEX `fk_TB_Exame_TB_Medico_temp1_idx` (`cdMedico_temp` ASC),
  ...
  CONSTRAINT `fk_TB_Cliente_has_TB_Exame_TB_Medico1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_Cliente_has_TB_Exame_TB_Consulta1`
    FOREIGN KEY (`cdConsulta`)
    REFERENCES `mydb`.`TB_Consulta` (`cdConsulta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_Exame_TB_Convenio1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_Exame_TB_Medico_temp1`
    FOREIGN KEY (`cdMedico_temp`)
    REFERENCES `mydb`.`TB_Medico_temp` (`cdMedico_temp`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Mensagem` (
  `cdMensagem` INT NOT NULL AUTO_INCREMENT,
  `cdCliente` INT NULL,
  `cdMedico` INT NULL,
  ...
  PRIMARY KEY (`cdMensagem`, `cdCliente`, `cdMedico`),
  INDEX `fk_TB_Mensagem_TB_Cliente_has_TB_Medico1_idx` (`cdCliente` ASC, `cdMedico` ASC),
  CONSTRAINT `fk_TB_Mensagem_TB_Cliente_has_TB_Medico1`
    FOREIGN KEY (`cdCliente` , `cdMedico`)
    REFERENCES `mydb`.`TB_Cliente_has_TB_Medico` (`cdCliente` , `cdMedico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`TB_ClinicaHospital`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_ClinicaHospital` (
  `cdClinicaHospital` INT NOT NULL,
  `nmClinicaHospital` VARCHAR(50) NOT NULL,
  `telefone` VARCHAR(12) NOT NULL,
  `status` TINYINT(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`cdClinicaHospital`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mydb`.`TB_Convenio_has_TB_Cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Convenio_has_TB_Cliente` (
  `cdConvenio` INT NOT NULL,
  `cdCliente` INT NOT NULL,
  PRIMARY KEY (`cdConvenio`, `cdCliente`),
  INDEX `fk_TB_Convenio_has_TB_Cliente_TB_Cliente1_idx` (`cdCliente` ASC),
  INDEX `fk_TB_Convenio_has_TB_Cliente_TB_Convenio1_idx` (`cdConvenio` ASC),
  CONSTRAINT `fk_TB_Convenio_has_TB_Cliente_TB_Convenio1`
    FOREIGN KEY (`cdConvenio`)
    REFERENCES `mydb`.`TB_Convenio` (`cdConvenio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_Convenio_has_TB_Cliente_TB_Cliente1`
    FOREIGN KEY (`cdCliente`)
    REFERENCES `mydb`.`TB_Cliente` (`cdPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`TB_ClinicaHospital_Medico`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_ClinicaHospital_Medico` (
  `cdClinicaHospital` INT NOT NULL,
  `cdPessoa` INT NOT NULL,
  PRIMARY KEY (`cdClinicaHospital`, `cdPessoa`),
  INDEX `fk_TB_ClinicaHospital_has_TB_Medico_TB_Medico1_idx` (`cdPessoa` ASC),
  INDEX `fk_TB_ClinicaHospital_has_TB_Medico_TB_ClinicaHospital1_idx` (`cdClinicaHospital` ASC),
  CONSTRAINT `fk_TB_ClinicaHospital_has_TB_Medico_TB_ClinicaHospital1`
    FOREIGN KEY (`cdClinicaHospital`)
    REFERENCES `mydb`.`TB_ClinicaHospital` (`cdClinicaHospital`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_ClinicaHospital_has_TB_Medico_TB_Medico1`
    FOREIGN KEY (`cdPessoa`)
    REFERENCES `mydb`.`TB_Medico` (`cdPessoa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
